...
public class ReadAndPrintXMLFileORIGINAL{
public static void main (String argv []){
    ...
    public static void getPeople(){//Displays the people in the XML file
    	try {
            ...
            int totalPersons = listOfPersons.getLength();
            System.out.println("Total no of people : " + totalPersons);
            if (totalPersons == 0) {//Returns error if there are no people in the file
            	System.err.println("No people are in this file!");
            	int status = 1;
            	System.exit(status);
            }
